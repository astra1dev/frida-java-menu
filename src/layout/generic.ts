...
import { apiLevel, app } from "../runtime";
import { GenericConfig } from "./config";
import { View, wrap } from "../ui/view";
import { Layout } from "../ui/layout";
import { TextView } from "../ui/textView";
import { Button } from "../ui/button";
import { Dialog, DialogCallback, DialogInputCallback } from "../ui/dialog";
import { RadioGroup } from "../ui/radioGroup";
import { SeekBarCallback } from "../ui/seekbar";
import { Spinner } from "../ui/spinner";
import { Switch, SwitchCallback } from "../ui/switch";
import { setConfig } from "../menu";
...
export abstract class GenericLayout {
    ...
    initializeParams(): void {
        this.params = Api.WindowManager_Params.$new(WRAP_CONTENT, WRAP_CONTENT, apiLevel >= 26 ? Api.WindowManager_Params.TYPE_APPLICATION_OVERLAY.value : Api.WindowManager_Params.TYPE_PHONE.value, 8, -3);
    };
