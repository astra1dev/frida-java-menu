...
import { Api, simple_spinner_dropdown_item } from "../api";
import { ThisWithIndexCallback } from "../types";
import { View } from "./view";
import { app } from "../runtime";
import { randomString } from "../utils/random";
import { config, sharedPreferences } from "../menu";
...
export class Spinner extends View {
    ...
    constructor(items: string[]) {
        ...
        const arrayAdapter = Api.ArrayAdapter.$new(app.context, simple_spinner_dropdown_item, this.items);
